...
def create_pdf(filename="fluxa_roadmap.pdf"):
    ...
    progress_data = [
        ...
        [Paragraph("Phase 5: User Interface (Frontend Canvas & Logs)", body_style), Paragraph("COMPLETED", done_badge), Paragraph("100%", body_style)],
        [Paragraph("Phase 6: Integrations Library (AI, HTTP, Logic)", body_style), Paragraph("COMPLETED", done_badge), Paragraph("100%", body_style)],
        [Paragraph("Phase 7: Webhooks & Schedule Triggers", body_style), Paragraph("PENDING", pending_badge), Paragraph("20%", body_style)],
        [Paragraph("Phase 8: Security & Credentials Storage", body_style), Paragraph("COMPLETED", done_badge), Paragraph("100%", body_style)],
    ]
    ...
    done_tasks = [
        ...
        [Paragraph("Visual Workspace", body_style), Paragraph("React Flow visual builder, node palettes, schema-driven properties configuration panel.", body_style)],
        [Paragraph("Execution Dashboard", body_style), Paragraph("Live simulation logger tracking node execution history status, durations, and output payloads.", body_style)],
        [Paragraph("Skeuomorphic Theme", body_style), Paragraph("Cyber-Skeuomorphic layout design with 3D hardware corner screws, glowing animated neon cables, and tactile switches.", body_style)],
        [Paragraph("Integrations", body_style), Paragraph("Built plugins and schema configurations for HTTP Request and AI Agent (Gemini) nodes.", body_style)],
    ]
